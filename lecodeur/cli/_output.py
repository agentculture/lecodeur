...
parsing lecodeur output can rely on this invariant. JSON mode routes structured
...
from lecodeur.cli._errors import LecodeurError
...
def emit_error(err: LecodeurError, *, json_mode: bool, stream: TextIO | None = None) -> None:
    """Write a :class:`LecodeurError` to stderr.
